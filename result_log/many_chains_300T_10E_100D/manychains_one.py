...
file_name1 = "/home/neu/Desktop/micro-ROS/microros_767/result_log/many_chains_300T_10E_100D/RCLC_5.log"
file_name2 = "/home/neu/Desktop/micro-ROS/microros_767/result_log/many_chains_300T_10E_100D/RCLC_5_100T.log"
...
def clctData1 (size_len, len_array, result_arry, list_index):
	global content
	for i in range(len(len_array)): 
		temp1 = len_array[i]
		temp2 = re.findall(r'\d+', content[temp1])
...
start1     = [x for x in range(len(content)) if (sensor) in content[x]]
size1	   = len(start1)
mtrx1	   = np.zeros([size1, 3], dtype = int)

clctData1(size1, start1, mtrx1, 1)
chain1_rclc = []
for i in range(len(mtrx1)) :
		if mtrx1[i,1] != 0 :
			temp = (mtrx1[i,1])/100
