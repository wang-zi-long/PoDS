...
file_name1 = "/home/neu/Desktop/micro-ROS/microros_767/result_log/data_size_300T_5E/TIDE_100.log"
file_name2 = "/home/neu/Desktop/micro-ROS/microros_767/result_log/data_size_300T_5E/RCLC_100.log"
file_name3 = "/home/neu/Desktop/micro-ROS/microros_767/result_log/data_size_300T_5E/TIDE_200.log"
file_name4 = "/home/neu/Desktop/micro-ROS/microros_767/result_log/data_size_300T_5E/RCLC_200.log"
file_name5 = "/home/neu/Desktop/micro-ROS/microros_767/result_log/data_size_300T_5E/TIDE_300.log"
file_name6 = "/home/neu/Desktop/micro-ROS/microros_767/result_log/data_size_300T_5E/RCLC_300.log"
file_name7 = "/home/neu/Desktop/micro-ROS/microros_767/result_log/data_size_300T_5E/TIDE_400.log"
file_name8 = "/home/neu/Desktop/micro-ROS/microros_767/result_log/data_size_300T_5E/RCLC_400.log"
file_name9 = "/home/neu/Desktop/micro-ROS/microros_767/result_log/data_size_300T_5E/TIDE_500.log"
file_name10 = "/home/neu/Desktop/micro-ROS/microros_767/result_log/data_size_300T_5E/RCLC_500.log"
...
chain3_rclc = []
for i in range(len(mtrx1)) :
		if mtrx1[i,1] != 0 and mtrx1[i,1] > 9000:
			temp = (mtrx1[i,1])/100
...
chain4_rclc = []
for i in range(len(mtrx1)) :
		if mtrx1[i,1] != 0 and mtrx1[i,1] > 12000:
			temp = (mtrx1[i,1])/100
...
chain5_rclc = []
for i in range(len(mtrx1)) :
		if mtrx1[i,1] != 0 and mtrx1[i,1] > 15000:
			temp = (mtrx1[i,1])/100
...
# #折线图
# x_position  = [100, 200, 300, 400, 500]#点的横坐标
...
# plt.plot(x_position,tide_mean,'s-',color = 'r',label="ATT-RLSTM")#s-:方形
# plt.plot(x_position,rclc_mean,'o-',color = 'g',label="CNN-RLSTM")#o-:圆形
# plt.xlabel("Data packet size")#横坐标名字
...
x_posn_fmt  = ["$100$", "$200$", "$300$", "$400$", "$500$"]
...
plt.xlabel('Data packet size [$byte$]', fontsize=12)
