...
RCL_WARN_UNUSED
rcl_ret_t
rcl_timer_call1(rcl_timer_t * timer);
RCL_PUBLIC
RCL_WARN_UNUSED
rcl_ret_t
rcl_timer_call2(rcl_timer_t * timer);
...
RCL_WARN_UNUSED
int64_t
rcl_timer_get_last_call_time(rcl_timer_t * timer);


RCL_PUBLIC
RCL_WARN_UNUSED
int64_t
rcl_timer_get_next_call_time_new(rcl_timer_t * timer);

RCL_PUBLIC
RCL_WARN_UNUSED
int64_t
rcl_timer_get_period_new(rcl_timer_t * timer);
